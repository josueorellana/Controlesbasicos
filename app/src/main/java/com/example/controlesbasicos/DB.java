...
public class DB extends SQLiteOpenHelper {
    ...
    private static final String SQldb = "CREATE TABLE Productos(id text,rev text, idProducto text,codigo text, descripcion text, marca text, presentacion text, precio text,foto text, estado text)";
    ...
    public String administrar_Productos(String accion, String[] datos) {
        try {
            ...
            if (accion.equals("nuevo")) {
                db.execSQL("INSERT INTO Productos(id,rev,idProducto,codigo,descripcion,marca,presentacion,precio,foto,estado) VALUES ('" + datos[0] + "', '" + datos[1] + "', '" +
                ...
                db.execSQL("UPDATE Productos SET id='" + datos[0] + "',rev='" + datos[1] + "', codigo='" + datos[3] + "',descripcion='" + datos[4] + "',marca='" +
                        datos[5] + "',presentacion='" + datos[6] + "',precio='" + datos[7] + "', foto='" + datos[8] + "',estado='" + datos[9] + "' WHERE idProducto='" + datos[2] + "'");
